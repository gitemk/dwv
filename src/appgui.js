...
dwv.gui.Toolbox = function (app)
{
    ...
    this.setup = function(list)
    {
        ...
        metadataSpan.className = "ui-icon ui-icon-clipboard";
        var metadata = document.createElement("button");
        metadata.appendChild(metadataSpan);
        metadata.title = "Metadata"; //dwv.i18n("basics.history");
        metadata.onclick = function() { toggle(".metadata"); };
        // DICOM tags
